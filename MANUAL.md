...
**Версия:** 3.4 (v0.1.0 Released)  
**Дата обновления:** 27 ноября 2025 г.  
**Статус:** ✅ Developer Preview Released
...
- **Desktop Client** — Tauri приложение (Rust + Svelte) **← v0.1.0 Released!**
- **LightRAG (CORTEX)** — графовая база знаний (GraphRAG)
- **LLaMA Factory** — fine-tuning моделей
- **Ollama** — локальные LLM модели

**Milestone:** ✅ Desktop Client MVP завершён и опубликован **27 ноября 2025 года** (v0.1.0 Developer Preview).
